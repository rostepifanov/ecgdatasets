...
class PhysioNetDataset(EcgDataset):
    ...
    def __init__(
        ...
        """
        super(EcgDataset, self).__init__(root, download, mapper)
    ...
    @property
    def _zippath(self):
        return self.root / ( self._name + '.zip' )
    ...
    def _check_integrity(self):
        return M._check_integrity(self._zippath, self._hash, M._calculate_sha256)
